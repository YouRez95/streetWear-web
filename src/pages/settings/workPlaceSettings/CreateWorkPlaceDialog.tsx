...
import { useCreateWorkPlace } from "@/hooks/useWorkers";
        ...
        <DialogContent className="[&>button]:hidden bg-foreground flex flex-col h-full max-w-full overflow-y-auto">
          ...
          <DialogHeader className="flex flex-col gap-2">
            <DialogTitle className="text-primary flex items-center gap-2">
              ...
              <p className="text-2xl font-bagel">Créer un atelier</p>
            </DialogTitle>
            <DialogDescription className="text-background/80 text-left">
              Créer un nouveau atelier en remplissant les informations
              ci-dessous.
            </DialogDescription>
          </DialogHeader>
