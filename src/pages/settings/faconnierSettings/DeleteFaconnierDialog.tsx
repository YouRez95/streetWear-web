...
export function DeleteFaconnierDialog({
  ...
  async function handleDeleteFaconnier() {
    if (!code) {
      ...
      >
        ...
        <DialogHeader className="flex flex-col gap-3 pb-4 pt-5 md:pt-0">
          ...
          >
            ...
            Supprimer le faconnier: <Badge>{faconnierName}</Badge>
          </DialogTitle>
          <DialogDescription className="text-background/80 text-base text-left">
            Êtes-vous sûr de vouloir supprimer ce faconnier ? Cette action est
            irréversible.
          </DialogDescription>
        </DialogHeader>
