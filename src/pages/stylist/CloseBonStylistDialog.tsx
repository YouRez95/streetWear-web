...
import { useStylistSummary, useToggleBonStylist } from "@/hooks/useStylist";
...
export function CloseBonStylistDialog({
  open,
  setOpen,
  selectedBonId,
  selectedStylistId,
  ...
  const { mutate: toggleBonStylist, isPending } = useToggleBonStylist();
        ...
        <div className="flex-1 px-2 md:px-0">
          <div className="grid gap-4 py-4">
            <div className="space-y-3">
              ...
              >
                Pour confirmer, tapez "Fermer" dans le champ ci-dessous
              </Label>
              <Input
                id="code"
                value={code}
