...
import { useDeleteAvanceStylist } from "@/hooks/useStylist";
...
export const DeleteAvanceStylistDialog = ({
  ...
  const { avanceId, amount, open } = openDeleteAvanceDialog;
  const isMobile = useMediaQuery("(max-width: 768px)");
  const { mutate: deleteAvanceStylist, isPending } = useDeleteAvanceStylist();
